...
while True:
    ...
    for bbox in bbox_id:
        ...
        if  results >=0:
            peoples_entering[id] = (x4,y4)
            cv2.rectangle(frame, (x3, y3), (x4, y4), (0, 0, 255), 2)

        if id in peoples_entering:
    ...
    ### people going outside 
        ...
        if  results2 >=0:
            peoples_exiting[id] = (x4,y4)
            cv2.rectangle(frame, (x3, y3), (x4, y4), (0, 255, 0), 2)

        if id in peoples_exiting:
    ...
    print("Exitig",len(exiting))
     
    cv2.putText(frame, str(len(entering)), (60, 80), cv2.FONT_HERSHEY_COMPLEX, (0.7), (0, 0, 255), 1)
    cv2.putText(frame, str(len(exiting)), (60, 140), cv2.FONT_HERSHEY_COMPLEX, (0.7), (255, 0, 255), 2)
